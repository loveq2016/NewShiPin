package com.xue.liang.app.v3.base.baseadapter;
...
public abstract class SectionedRecyclerViewAdapter<H extends RecyclerView.ViewHolder,
    ...
    protected RecyclerItemClickListener mItemClickLister = null;
    ...
    public RecyclerItemClickListener getItemClickLister() {
        return mItemClickLister;
    }

    public void setItemClickLister(RecyclerItemClickListener mItemClickLister) {
    ...
    public void setmItemClickLister(RecyclerItemClickListener mItemClickLister) {
        this.mItemClickLister = mItemClickLister;
    }
